...
func LoadConfig() Config {
	return Config{
		...
		SupabaseURL:            strings.TrimRight(getenvFallback("SUPABASE_URL", ""), "/"),
		SupabaseServiceRoleKey: getenvFallback("SUPABASE_SERVICE_ROLE_KEY", ""),
		SupabaseAnonKey:        getenvFallback("SUPABASE_ANON_KEY", ""),
